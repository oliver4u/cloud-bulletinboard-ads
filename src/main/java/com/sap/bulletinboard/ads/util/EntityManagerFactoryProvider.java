...
public class EntityManagerFactoryProvider {
    ...
    public static LocalContainerEntityManagerFactoryBean get(DataSource dataSource, String... packagesToScan ) {
        ...
        entityManagerFactoryBean.setJpaPropertyMap(getJpaPropertyMap(dataSource.getClass().getClassLoader()));
     ...
     */
    private static Map<String, Object> getJpaPropertyMap(ClassLoader classLoader) {
