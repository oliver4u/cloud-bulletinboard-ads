...
export VCAP_SERVICES='{"postgresql-9.6":[{"name":"postgresql","label":"postgresql-9.6","credentials":{"dbname":"test","hostname":"127.0.0.1","password":"test123!","port":"5432","uri":"postgres://testuser:test123!@localhost:5432/test","username":"testuser"},"tags":["relational","postgresql"],"plan":"free"}]}'
